...
enemies.E37.bestiaryItem = 'bestiaryTag("Requires: ⛏️ Gathering Level 3")+bestiaryItem("I417","drop")';
...
items.I21.description = 'Consumable - Battle<br><FONT COLOR="#1EFF0C">Use: Inflicts'+buffIcon("B1")+'Poison over 60 seconds<FONT COLOR="gray"> (2 minute Cooldown)';
...
items.I12.description = 'Consumable - Battle<br><FONT COLOR="#1EFF0C">Use: Restores 600 Health';
items.I12.flavor = '"Don\'t complain, it tastes like chicken."';
items.I12.quality = 'Common';
items.I12.sell = 200;
items.I12.use = ' playSound("audio/monch.mp3"); playerHealingDamage(600); animState("rpgPlayerImg", "gelatineHigh 0.4s 1"); items.I12.count--; ';
items.I12.max = 5;
...
items.I205.quality = 'Epic';
items.I205.sell = 15000;
items.I205.use = 'rareItemDrop(rareItems[rng(0,(rareItems2.length-1))],1); rareItemDrop(rareItems2[rng(0,(rareItems2.length-1))],1); items.I205.count--; if (rng(1,6)===1) {items.I284.count++;}';
...
items.I222.quality = 'Uncommon';
items.I222.sell = 5000;
items.I222.max = 10;
...
items.I72.description =  `'Equipable - Trinket<br>'+rUpgLvl("I72")+'<br><FONT COLOR="#1EFF0C">+'+ beautify(rUpgDmg("I72", 0.8))+' Max Health'`;
...
items.I72.stats = 'trinketAdditiveMaxHp = rUpgDmg("I72", 0.8); items.I72.statUp = 0.1'
...
items.I47.altskills = 'rUpgSkill("I47", "Poison Fangs: <FONT COLOR=darkorange>1/10<FONT COLOR=#1EFF0C> chance to inflict"+buffIcon("B1")+"Poison, <FONT COLOR=darkorange>dealing 25% of your weapon damage as"+natureIcon+"Nature Damage over 10 seconds. Can stack","active",0)+"<br>"+rUpgSkill("I47", "Neurotoxin: Poisoned enemies take 20% more"+natureIcon+"Nature Damage","passive",30)'
...
items.I474.description = 'Consumable - Miscellaneous<br><FONT COLOR="#1EFF0C">Permanently unlocks the Armory at the top of the screen. Store and level up gear and weapons on it to gain Mastery. You can buy back adquired gear too';
...
items.I499 = {};
items.I499.name = 'Mark of Embers';
items.I499.description = `'Equipable - Luma<br><FONT COLOR="gray">Mundane - '+rCELvl("I499")`
items.I499.skills = 'rUpgSkill("I499", "+"+(rCEDmg("I499",0.2, 1.0092)*100).toFixed(0)+"% "+elementalIcon+"Elemental Bonus","passive",0)'
items.I499.flavor = '"A beautiful crystallization of pure turtle emotions."';
items.I499.quality = 'Uncommon';
items.I499.stats = 'items.I499.statUp = rCEDmg("I499",0.2, 1.0092)'
items.I499.remove = 'items.I499.statUp = 0'
items.I499.statUp = 0

items.I500 = {};
items.I500.name = 'Will of Embers';
items.I500.description = `'Equipable - Luma<br><FONT COLOR="gray">Mundane - '+rCELvl("I500")`
items.I500.skills = 'rUpgSkill("I500", "+"+(rCEDmg("I500",0.4, 1.008)*100).toFixed(0)+"% "+elementalIcon+"Elemental Bonus","passive",0)'
items.I500.flavor = '"A beautiful crystallization of pure turtle emotions."';
items.I500.quality = 'Rare';
items.I500.stats = 'items.I500.statUp = rCEDmg("I500",0.4, 1.008)'
items.I500.remove = 'items.I500.statUp = 0'
items.I500.statUp = 0

items.I501 = {};
items.I501.name = 'Soul of Embers';
items.I501.description = `'Equipable - Luma<br><FONT COLOR="gray">Mundane - '+rCELvl("I501")`
items.I501.skills = 'rUpgSkill("I501", "+"+(rCEDmg("I501",0.6, 1.006)*100).toFixed(0)+"% "+elementalIcon+"Elemental Bonus","passive",0)'
items.I501.flavor = '"A beautiful crystallization of pure turtle emotions."';
items.I501.quality = 'Epic';
items.I501.stats = 'items.I501.statUp = rCEDmg("I501",0.6, 1.006)'
items.I501.remove = 'items.I501.statUp = 0'
items.I501.statUp = 0

items.I502 = {};
items.I502.name = 'Heart of Embers';
items.I502.description = `'Equipable - Luma<br><FONT COLOR="gray">Mundane - '+rCELvl("I502")`
items.I502.skills = 'rUpgSkill("I502", "+"+(rCEDmg("I502",0.8, 1.045)*100).toFixed(0)+"% "+elementalIcon+"Elemental Bonus","passive",0)'
items.I502.flavor = '"A beautiful crystallization of pure turtle emotions."';
items.I502.quality = 'Mythic';
items.I502.stats = 'items.I502.statUp = rCEDmg("I502",0.8, 1.045)'
items.I502.remove = 'items.I502.statUp = 0'
items.I502.statUp = 0


items.I527 = {};
items.I527.name = 'Scratch Card';
items.I527.description = 'Consumable - Miscellaneous<br><FONT COLOR="#1EFF0C">Use: Scratch the card!'
items.I527.flavor = '"99% of turtles quit before winning big!"';
items.I527.quality = 'Epic';
items.I527.sell = 30000;
items.I527.use = 'startScratchMinigame(); items.I527.count--; addItem()';
...
Object.keys(items).forEach(function(key) {
  ...
  if (items[key].description.startsWith("'Equipable")) {items[key].sort = "equipable"; items[key].dynamic=true}
  if (items[key].description.startsWith("'Equipable - Luma")) {
    items[key].sort = "CE";
    items[key].CELevel = 0;
    items[key].dynamic = true;
    items[key].max = 1;
    items[key].series = "omega";
    items[key].use = 'gearSwap(items.'+key+'.id, rpgPlayer.ceSlot, "rpgCeSlot", "ce")'
    items[key].sell = 1;
...
buffs.B54.effect = function() { statHidden.enemyNatureDot = 10 };
...
Object.keys(areas).forEach(function(key) {
  areas[key].shopLevel = 1;    
  areas[key].shopLevelStartingPrice = 1000;        
...
shopItems.A2S0 = {}
shopItems.A2S0.item = 'I11';
shopItems.A2S0.price = 7000;
shopItems.A2S0.stock = "∞";
...
mail.MR1.effect = "unlocks.areas = true; unlocksReveal(); did('areaButton').style.animation = 'newGameTip 1s infinite linear'; unlockAnimation('Areas Unlocked!', 'Explore different places by switching to new areas on the bottom right menu. Some areas will be blocked by both level, and mastery before you can proceed to them.', 'img/src/areas/A1M.png')"
...
mail.MR3.item = 'I174'
mail.MR3.effect = "items.I174.count++; unlocks.dungeons=true; unlocksReveal(); did('dungeonButton').style.animation = 'newGameTip 1s infinite linear'; unlockAnimation('Dungeons Unlocked!', 'Explore different dungeons on the bottom right menu. Dungeon entrances are limited and recharge overtime. Some Dungeons will be blocked by mastery before you can proceed to them.', 'img/src/areas/A6M.png')"
...
mail.MR4.item = 'I315'
mail.MR4.effect = "items.I315.gotOnce=true; unlocks.bestiary = true; unlocksReveal(); unlockAnimation('Medal Case Unlocked!', 'Allows the collection of medals and mastery in the bestiary by defeating an enemy 10 000 times.', 'img/src/items/I315.jpg')"
...
mail.MR5.item = 'I287'
mail.MR5.effect = "items.I287.gotOnce = true; unlocks.garden = true; unlocksReveal(); unlockAnimation('Garden Unlocked!', 'Find your garden in your Guildwork tab. Discover different seeds to gain mastery. You can find a detailed guide in the game guide section.', 'img/src/items/I287.jpg')"
...
talent.TG1B.description = `"Attempts to <span style='color:orange'>steal an item marked as [steal]</span> from the enemy. Always uses 10% of your Max Magic. Some items might increase Steal chance."`; 
